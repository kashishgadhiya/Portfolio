...
<div className=" flex md:hidden   justify-between items-center my-4 mx-1">
    <Link href={"/"}><Image src={logo}  alt="logo" height={50}className="md:w-10 m-2" ></Image></Link>
    ...
    {
    moblieNav &&(
<div className="md:hidden p-4 bg-transparent rounded-lg mt-2 flex flex-col gap-3 font-semibold text-center text-white moblienav "
...
<Link href={'/'} className="hover:font-semibold">Home</Link>
                    ...
                    <Link href={'#project'} className="hover:font-semibold">Projects</Link>
        ...
        <nav className="flex  items-center   text-white py-2 px-7 navbar   rounded-full  justify-between ">
            <div className="font-extrabold text-3xl  ">
                ...
                <Link href={'/'}> <Image src={logo} width={70} alt="logo"></Image></Link>
            </div>
